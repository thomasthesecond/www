  ...
  <div className={styles.footer}>
    <Grid rows="3">
      ...
      <div className={styles.social}>
        <a href="https://twitter.com/aptible" target="_blank" rel="noopener noreferrer">
          {twitterIcon}
        </a>

        <a href="https://www.facebook.com/aptible/" target="_blank" rel="noopener noreferrer">
          {fbIcon}
        </a>

        <a href="https://github.com/aptible" target="_blank" rel="noopener noreferrer">
          {githubIcon}
        </a>

        <a href="https://linkedin.com/company/aptible" target="_blank" rel="noopener noreferrer">
          {linkedInIcon}
        </a>
      </div>
